          ...
          <div>
            ...
            <div
              ...
              className={`border-2 border-dashed rounded-xl p-5 transition-all duration-300 ${
                isDragging ? 'border-primary bg-primary/10 scale-105 shadow-primary-lg' : 'border-border/50 bg-white/80 hover:bg-accent/30 hover:border-primary/40 shadow-modern backdrop-blur-sm'
              }`}
            >
    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-white via-white to-accent/10 animate-fade-in">
      ...
      <div className="flex-1 p-4 sm:p-6 max-w-6xl mx-auto w-full">
        ...
        <div className="mb-6 sm:mb-8 animate-slide-up">
          ...
          {/* Metadata */}
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 text-xs sm:text-sm text-muted-foreground mt-3 sm:mt-4 flex-wrap">
