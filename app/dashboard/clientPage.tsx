...
export default function DashboardPageClient({
  ...
  // Convert labsByCourse prop to Map
  useEffect(() => {
    const labsMap = new Map<string, Lab[]>();
    Object.entries(labsByCourseProp || {}).forEach(([courseId, labsList]) => {
