    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-white via-white to-accent/20 p-4 sm:p-6 animate-fade-in">
      <div className="w-full max-w-3xl animate-scale-in">
        <div className="border-2 border-border/50 bg-gradient-card p-6 sm:p-8 lg:p-10 rounded-2xl shadow-modern-xl backdrop-blur-sm">
          ...
          <div className="space-y-5 sm:space-y-6 mb-7 sm:mb-9">
          ...
          <div className="flex items-center gap-3 sm:gap-4 mb-5 sm:mb-7 p-4 bg-muted/30 border border-border/30 rounded-xl backdrop-blur-sm animate-slide-up">
            <input
              type="checkbox"
              id="agree"
              checked={agreed}
              onChange={(e) => setAgreed(e.target.checked)}
              className="w-5 h-5 sm:w-6 sm:h-6 border-2 border-primary rounded cursor-pointer accent-primary transition-all duration-200 flex-shrink-0"
            />
